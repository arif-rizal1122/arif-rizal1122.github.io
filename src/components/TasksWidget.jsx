  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
      ...
      <form onSubmit={addTask} className="flex gap-2 mb-6">
        ...
        />
        <button type="submit" aria-label="Tambah tugas" className="bg-indigo-600 hover:bg-indigo-700 text-white p-2 px-4 rounded-lg transition-colors">
            ...
            <div key={task.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-lg group">
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className={`w-5 h-5 rounded border ${task.completed ? 'bg-green-500 border-green-500' : 'border-gray-300 dark:border-gray-600'} flex items-center justify-center transition-colors`}
                >
